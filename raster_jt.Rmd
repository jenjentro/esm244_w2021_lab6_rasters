---
title: "ESM 244 Lab 6 Pt 2 - Rasters"
...
library(raster)
library(tidyverse) # Load tidyverse after raster package so that dplyr::select() can take precedence
library(here)
library(sf)
library(fasterize)
```
...
```{r}
ls_1 <- raster::aggregate(ls_1, fact = 3, fun = mean) # takes a 3 x 3 grid and turns it into one cell
